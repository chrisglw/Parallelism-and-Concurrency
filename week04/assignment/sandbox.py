...
class Dealer(threading.Thread):
    ...
    def __init__(self, queue, emptyQueue, fullQueue, queue_stats):
...
def main():
    ...
    emptyQueue = threading.Semaphore(0)
    fullQueue = threading.Semaphore(MAX_QUEUE_SIZE)
    ...
    factory = Factory(queue, fullQueue, emptyQueue)
    # TODO create your one dealership
    dealer = Dealer(queue, emptyQueue, fullQueue, queue_stats)
...
#     def __init__(self, queue, emptyQueue, queue_stats):
#         # TODO, you need to add arguments that pass all of data that 1 Dealer needs
#         # to sell a car
#         threading.Thread.__init__(self)
#         self.queue = queue
...
#     factory = Factory(queue, fullQueue, emptyQueue)
#     # TODO create your one dealership
#     dealer = Dealer(queue, emptyQueue, queue_stats)
...
# #     def __init__(self, queue, dealer_semaphore):
# #         # TODO, you need to add arguments that will pass all of data that 1 factory needs
# #         # to create cars and to place them in a queue.
# #         threading.Thread.__init__(self)
# #         self.queue = queue
...
# #     def __init__(self, queue, dealer_semaphore, queue_stats):
# #         # TODO, you need to add arguments that pass all of data that 1 Dealer needs
# #         # to sell a car
# #         threading.Thread.__init__(self)
# #         self.queue = queue
...
# #     # TODO create your one factory
# #     factory = Factory(queue, dealer_semaphore)
# #     # TODO create your one dealership
# #     dealer = Dealer(queue, dealer_semaphore, queue_stats)
